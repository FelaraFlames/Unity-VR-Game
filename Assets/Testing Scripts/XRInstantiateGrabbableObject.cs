...
public class XRInstantiateGrabbableObject : UnityEngine.XR.Interaction.Toolkit.Interactables.XRBaseInteractable
{
    ...
    protected override void OnSelectEntered(SelectEnterEventArgs args)
    {
        ...
        UnityEngine.XR.Interaction.Toolkit.Interactables.XRGrabInteractable objectInteractable = newObject.GetComponent<UnityEngine.XR.Interaction.Toolkit.Interactables.XRGrabInteractable>();
